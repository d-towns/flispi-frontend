  ...
  return (
    <>
      <div className="pt-2 relative mx-auto text-gray-600 w-full px-2 flex flex-row items-center">
        <input className="relative w-full cursor-default overflow-hidden rounded-lg text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-blue-300 sm:text-sm h-10 px-5 bg-white focus:bg-gray-100"
