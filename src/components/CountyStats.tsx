...
const CountyStats = () => {
    return (
        ...
        <div className="relative mx-auto flex max-w-xs flex-col gap-y-4" data-aos="zoom-in-right" data-aos-duration="1000">
          ...
          <dl className="relative border border-black order-first z-10 mb-4 rounded-lg bg-white p-6 text-3xl font-semibold tracking-tight text-gray-900 shadow-md lg:text-5xl sm:text-3xl">
