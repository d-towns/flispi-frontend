...
const SignupPage = () => {
    ...
    return (
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Sign up for an account</h2>
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            ...
            <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
              <div className="flex h-6 items-center">
                <Switch
                  ...
                  className={classNames(
                    agreed ? 'bg-[#8ba2be]' : 'bg-gray-200',
                    'flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#8ba2be]'
                  )}
                >
              ...
              <Switch.Label className="text-sm leading-6 text-gray-600">
                ...
                <a href="#" className="font-semibold text-[#8ba2be]">
                  privacy&nbsp;policy
                </a>
                .
              </Switch.Label>
