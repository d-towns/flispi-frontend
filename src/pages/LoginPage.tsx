        ...
        <div className="w-full h-100">
          ...
          <div className="mt-6" >
            <div>
              ...
              <input name="" id="" placeholder="Enter Email Address" onChange={(e) => setUsername(e.target.value)} className=" shadow w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-gray-100 focus:outline-none" autoFocus required />
            </div>
            ...
            <div className="mt-4">
              ...
              <input type="password" name="" id="" placeholder="Enter Password" minLength={6} className="w-full shadow px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
                focus:bg-gray-100 focus:outline-none" onChange={(e) => setPassword(e.target.value)} required />
            </div>
          ...
          <p className="mt-8">Need an account? <a href="/signup" className="text-blue-500 hover:text-blue-700 font-semibold">Create an
            account</a></p>
