  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-left">
        ...
        <p className="mb-4">Towns Captial-Flint LLC does not own any of the content available on the site. All of it is from thelandbank.org and is available for view there. if you are a rights holder for any content used on the site, you can request it be taken down by sending an email to dennis@dennistowns.com</p>
        ...
        <p className="mb-4">As a user of our site, you may be asked to register with us and provide private information. You are responsible for ensuring the accuracy of this information, and you are responsible for maintaining the safety and security of your identifying information.</p>

        <h2 className="text-xl font-semibold text-gray-900 mb-2">5. Modifications to Our Service</h2>
